    ...
    <div className='absolute w-full top-0 flex flex-col justify-center items-center text-center text-white my-36 z-10'>
       ...
       <div className='p-5 flex flex-col items-center'>
            ...
            <div className='hero--btns mt-10 w-4/5 px-4 flex justify-between gap-4 md:justify-center'>
                <button className='bg-white text-red-400 py-3 w-2/4 md:w-1/4 font-semibold rounded-full'>Start for Free</button>
                <button className='bg-transparent outline outline-1 py-3 w-2/4 md:w-1/4 font-semibold rounded-full'>Learn More</button>
            </div>
        </div>
